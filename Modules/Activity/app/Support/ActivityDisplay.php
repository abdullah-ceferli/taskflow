...
final class ActivityDisplay
{
    public static function label(Activity $activity): string
    {
        return match ($activity->event) {
            ...
            'task.board_conflict' => 'Board update conflict detected',
            'task.dependency_added' => 'Task dependency added',
            'task.dependency_removed' => 'Task dependency removed',
            'task.recurring_generated' => 'Recurring task generated',
            'project.milestone_created' => 'Milestone created',
