...
class DashboardService
{
    ...
    public function summary(User $user): array
    {
        ...
        return [
            ...
            'projectDistribution' => (clone $projects)->withCount(['tasks' => fn ($query) => $query->whereIn('id', (clone $tasks)->select('id'))])->orderBy('name')->get(),
        ];
    }
    ...
    public function overdueTasks(User $user)
    {
        ...
        return $this->tasksFor($user, (clone $projects)->pluck('id')->all())
